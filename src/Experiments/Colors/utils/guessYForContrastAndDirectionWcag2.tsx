 ...
 */
export const guessYForContrastAndDirectionWcag2 = ({
  direction,
  initY,
  ...restOpts
}: {
  ...
  _searchYForContrastAndDirectionWcag2({
    direction,
    initY,
...
const _searchYForContrastAndDirectionWcag2 = ({
  attempt = 0,
  attemptsMax = 10,
  direction,
  errorMargin = 0.5,
  ...
  return _searchYForContrastAndDirectionWcag2({
    attempt: attempt + 1,
    attemptsMax,
    direction,
    errorMargin,
