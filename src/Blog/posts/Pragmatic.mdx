...
I'd argue that the main (or at least a major?) value prop of unit testing is as a tool for exploring the space of your code's _pragmatics._
...
- In an ideal non-visual testing environment, your tests serve the same function.

In text-based debugging tools, you can pause execution and inspect state. But even if you can adjust state on the fly mid-execution, you can't visualize several different permutations of state simultaneously.
